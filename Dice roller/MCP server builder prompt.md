...
I want to create a very simple dice roller mcp server, I want it to do coin flips, dnd stuff, any kind of dice roller mechanic, bake that in. Make it simple, clean.
